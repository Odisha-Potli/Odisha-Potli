...
export default function ProductPage() {
      ...
      try {
        ...
        if (productResponse.data.success) {
          ...
          if (foundProduct) {
            ...
            const categorySlug = slugify(foundProduct.category.name, {
              lower: true,
            });
  ...
  const isInCart = cart.some(item => item._id === productId); // Check if product is in cart
          ...
          <div className="lg:w-3/4 flex flex-col gap-8">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex flex-row gap-2 overflow-x-auto">
                  {product.images.map((image, index) => (
                    <img
                      ...
                      className={`w-24 h-24 sm:w-28 sm:h-28 object-cover rounded-md cursor-pointer border-2 ${
                        mainImage === image
                          ? "border-[#d99527]"
                          : "border-gray-200"
              ...
              <div className="lg:w-1/3 flex flex-col gap-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-[#97571c]">
                  {product.name}
                </h1>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700 text-sm">
                    ({product.ratings.average} / 5, {product.ratings.count}{" "}
                    reviews)
                  </span>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-xl sm:text-2xl font-semibold text-[#97571c]">
                    ₹{product.price}
                  </span>
                ...
                <div className="flex gap-2">
                  ...
                  <div className="flex-1">
                    <button
                      ...
                      className="w-full bg-[#97571c] text-white py-2 rounded-md hover:bg-[#604a3bfa] transition-colors flex items-center justify-center gap-2"
                  ...
                  <div className="flex-1">
                    ...
                    >
                      {isInWishlist ? (
                        <HeartFilled size={18} className="text-red-600 fill-red-600" />
                      ) : (
                        <Heart size={18} />
                      )}
                      {isInWishlist
            ...
            {relatedProducts.length > 0 && (
              <div className="lg:hidden mt-8">
                <h2 className="text-lg sm:text-xl font-semibold text-[#97571c] mb-4">
                  Related Products
                </h2>
